# WorkTime Report Assembler

## Purpose

Defines the shared worktime report assembly capability that centralises hour aggregation and entry construction for employee and project-lead worktime reporting.
