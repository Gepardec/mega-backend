...
Defines the formal use case and domain model for querying employee absences within the `worktime` BC, including the `AbsenceType` enum and the mapping rules for raw ZEP absence codes.
