...
Defines how the notification BC schedules and dispatches reminder emails to users by role, including the domain policy that determines which reminders fire on a given date and the Quartz-based scheduler adapter that triggers the use case daily.
