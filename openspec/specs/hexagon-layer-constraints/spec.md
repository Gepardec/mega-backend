# Hexagon Layer Constraints

## Purpose

Defines the architectural guardrails that keep `com.gepardec.mega.hexagon` aligned with hexagonal layering, domain purity, port conventions, and adapter placement. These rules are enforced by ArchUnit tests so structural violations fail fast during development.
