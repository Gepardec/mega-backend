# Employment Periods Aggregate

## Purpose

TBD — defines the `EmploymentPeriods` aggregate that wraps a list of `EmploymentPeriod` entries and exposes temporal query methods for determining active employment periods by date or payroll month.
